...
; Monero GUI wallet
Source: "bin\mynt-wallet-gui.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
; Monero CLI wallet
Source: "bin\mynt-wallet-cli.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Monero wallet RPC interface implementation
Source: "bin\myntnote-wallet-rpc.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Monero daemon
Source: "bin\myntd.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
Source: "bin\mynt-blockchain-export.exe"; DestDir: "{app}"; Flags: comparetimestamp
Source: "bin\mynt-blockchain-import.exe"; DestDir: "{app}"; Flags: comparetimestamp
Source: "bin\mynt-utils-deserialize.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\mynt');
